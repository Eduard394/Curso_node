...
exports.add = async(req, res, next) => {
 ...
 exports.update = async(req, res,next) => {
    try
    {
        const libro = await models.Libro.findOneAndUpdate({_id: req.body.id}, {$set:{caratula:req.body.caratula,nombre:req.body.nombre,descripcion: req.body.descripcion,valorUnitario:req.body.valorUnitario,categorias:req.body.categorias} }, {new: true}, (err, doc) => {
            if (err) {
